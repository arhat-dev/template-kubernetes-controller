...
install_deepcopy_gen() {
  _install_go_bin "k8s.io/code-generator@v0.19.7" "./cmd/client-gen" "${GOPATH}/bin/client-gen"
  _install_go_bin "k8s.io/code-generator@v0.19.7" "./cmd/lister-gen" "${GOPATH}/bin/lister-gen"
  _install_go_bin "k8s.io/code-generator@v0.19.7" "./cmd/informer-gen" "${GOPATH}/bin/informer-gen"
}

install_controller_gen() {
  _install_go_bin "sigs.k8s.io/controller-tools@v0.4.1" "./cmd/controller-gen" "${CONTROLLER_GEN}"
}
...
_do_gen_clients() {
  ...
  bash "${GOPATH}/pkg/mod/k8s.io/code-generator@v0.19.7/generate-groups.sh" client,lister,informer \
...
_do_gen_crd_manifests() {
  ...
  "${CONTROLLER_GEN}" crd:preserveUnknownFields=true,crdVersions=v1beta1 output:dir=./cicd/deploy/charts/template-kubernetes-controller/crds/ paths="./pkg/apis/${group_name}/..."
}
